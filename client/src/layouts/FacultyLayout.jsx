...
const SidebarContent = ({ navItems, location, user, initials, handleLogout, onClose, role }) => (
    <>
        {/* Logo */}
        <div className="flex items-center gap-3 px-6 py-5 border-b border-gray-200">
            ...
            <div className="flex-1">
                ...
                <p className="text-xs text-gray-400 font-medium">{role} Portal</p>
            </div>
            {onClose && (
                <button
                    onClick={onClose}
        ...
        <div className="px-4 py-4 border-t border-gray-200">
            <div className="flex items-center gap-3 px-3 py-3 rounded-xl mb-2 bg-gray-50">
                ...
                <div className="overflow-hidden">
                    ...
                    <p className="text-sm font-semibold" style={{ color: BLUE }}>{role}</p>
                </div>
            </div>
            <button
